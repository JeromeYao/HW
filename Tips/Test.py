...
if __name__ == '__main__':
    # 测试
    send_url_douban = "https://movie.douban.com/"

    link_regex_douban = '(/subject/[\d]+/)'  # 获取链接的规则

    # 使用类的方式来写，下面两个一样结果
    link_crawler(send_url_douban, link_regex_douban, max_depath=2, scrape_callback=ScrapeCallback())
    # link_crawler(send_url_douban, link_regex_douban, max_depath=2, scrape_callback=scrape_callback)
